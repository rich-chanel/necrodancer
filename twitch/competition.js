function refresh() {
    ...
    T2.innerHTML = "<iframe src='https://player.twitch.tv/?channel=" + P2 + "&parent=rich-chanel.github.io' height='528' width='938' allowfullscreen='true' style='margin-left: 4px;'></iframe></td>";
